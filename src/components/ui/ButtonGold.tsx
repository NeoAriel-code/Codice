...
export interface ButtonGoldProps
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "bg-gold text-ink hover:bg-gold-hover active:bg-gold-hover",
    ...
    >
      {loading ? (
        <>
          <SealIcon size={16} spinning className="text-ink" />
          <span>Buscando en los archivos...</span>
        </>
      ) : (
        <>
